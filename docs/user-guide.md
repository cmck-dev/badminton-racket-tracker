...
- **Edit** — update any racket details at any time
- **Delete** — permanently removes the racket and all associated sessions and stringing records
...
When a string breaks, edit the stringing record and fill in **Broke After** — the number of sessions it lasted. This helps you track string durability over time.

### Active String

The most recent stringing for each racket is marked as **Active**. This is used to calculate sessions since last stringing on the Dashboard.
